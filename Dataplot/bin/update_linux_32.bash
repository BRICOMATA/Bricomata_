...
#
#            2. This version is for 32-bit machines.  There
#               is a separate build script for 64-bit machines.
#
...
#               f. IPREC    = by default, the compile options are set
#                             to use 64-bit for both single and double
#                             precision.  You can alternatively set this
#                             so that single precision is 32-bit and
#                             double precision is 64-bit.
...
#               h. Dataplot can optionally take advantage of several
...
#
#LDFLAG="-L$HOME/lib -L/usr/lib  -L/usr/local/lib"
LDFLAG="-L/usr/lib  -L/usr/local/lib"
CFLAGS="-ansi -c -I/usr/include -I/usr/local/include"
#
if [ $IPREC = "64-64" ]; then
