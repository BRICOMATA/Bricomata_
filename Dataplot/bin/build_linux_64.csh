...
if ( $HAVE_UBUNTU == "on" ) then
   set LDFLAG = "-L/usr/lib/x86_64-linux-gnu -L/usr/lib  -L/usr/local/lib"
   set CFLAGS = "-ansi -c -m64"
endif
#
...
if ( $HAVE_ISNAN == "on" ) then
   set FFLAGS2 = "$FFLAGS2 -DHAVE_ISNAN
endif
#
if ( $HAVE_EXECUTE_COMMAND_LINE == "on" ) then
   set FFLAGS2 = "$FFLAGS2 -DHAVE_EXECUTE_COMMAND_LINE
endif
#
