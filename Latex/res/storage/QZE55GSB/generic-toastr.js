function showToastr(options) {
	...
	* @param {String} icon - The class of the icon to be displayed (icon-gizmo-check by default).
	...
	*/
	...
	var distance = (parseInt(config.topDistance) + document.body.scrollTop).toString();
	$('#genericToastr')
