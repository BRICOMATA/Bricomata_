...
#        self._insert_menu()
#+
        action = Gio.SimpleAction(name="fold")
        action.connect('activate', self.fold)
...
#        self._remove_menu()
        ...
        #self.fold_off
#+
        self.window.remove_action("fold")
...
#+
#        self.window.lookup_action("fold").set_enabled('doc is not None')
        self.window.lookup_action("fold").set_enabled(self.doc != None)
    
#    def _insert_menu(self):
#        manager = self.window.get_ui_manager()
#        self._action_group = Gtk.ActionGroup("foldPyPluginActions")
...
class FoldingAppActivatable(GObject.Object, Gedit.AppActivatable):
    ...
    def do_activate(self):
        self.app.add_accelerator("<Alt>Z", "win.fold", None)
        self.app.add_accelerator("<Alt>X", "win.deepest", None)
        self.app.add_accelerator("<Shift><Alt>X", "win.fold_off", None)

        self.menu_ext = self.extend_menu("tools-section")
        item = Gio.MenuItem.new(_("fold"), "win.fold")
        self.menu_ext.append_menu_item(item)

    def do_deactivate(self):
        self.app.remove_accelerator("win.fold", None)
        self.menu_ext = None
